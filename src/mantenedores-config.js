const MAINTAINERS = {
  temporadas: {
    ...
    create: {
      ...
      optional: ["activa", "cerrada", "observacion_cierre"],
    },
    update: {
      allowed: ["codigo", "nombre", "fecha_inicio", "fecha_fin", "activa", "cerrada", "observacion_cierre", "fecha_cierre"],
    },
    timestamps: {
      created: "created_at",
      updated: "updated_at",
  ...
  tarifas: {
    ...
    alias: "t",
    idColumn: "id_tarifa",
    from: "[cfl].[CFL_tarifa] t INNER JOIN [cfl].[CFL_tipo_camion] tc ON tc.id_tipo_camion = t.id_tipo_camion INNER JOIN [cfl].[CFL_temporada] tp ON tp.id_temporada = t.id_temporada INNER JOIN [cfl].[CFL_ruta] r ON r.id_ruta = t.id_ruta",
