...
const fleteManualBody = z.object({
  cabecera: z.object({
    ...
    id_empresa_transporte: z.coerce.number().int().positive().optional().nullable(),
    id_chofer: z.coerce.number().int().positive().optional().nullable(),
    id_camion: z.coerce.number().int().positive().optional().nullable(),
    id_movil: z.coerce.number().int().positive().optional().nullable(),
    sentido_flete: z.enum(['IDA', 'VUELTA']).optional().nullable(),
